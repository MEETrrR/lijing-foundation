...
export function renderNavigation(currentRoute) {
  ...
  return `<button class="feature-nav-trigger" type="button" data-action="toggle-feature-nav" aria-label="打开全部功能导航" aria-expanded="false" aria-controls="feature-nav-overlay" title="打开全部功能导航"><span class="feature-nav-trigger__orbit"></span>${mark("☯")}<span class="feature-nav-trigger__label">全部功能</span></button>
