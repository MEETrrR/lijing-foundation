...
const OPERATION_SECURITY = {
  ...
  "GET /api/v1/auth/registration-policy": "public",
  "POST /api/v1/auth/login": "public",
  "POST /api/v1/auth/logout": "bearer",
  "GET /api/v1/auth/me": "bearer",
  "GET /api/v1/me/progress": "bearer",
  "GET /api/v1/me/memories": "bearer",
  "GET /api/v1/me/learning-snapshot": "bearer",
  "GET /api/v1/knowledge/sources": "bearer",
  "GET /api/v1/knowledge/search": "bearer",
  "GET /api/v1/knowledge/learning-guidance": "bearer",
  ...
  "POST /api/v1/learning/attempts": "bearer",
  "GET /api/v1/learning-routes/sources": "bearer",
  "GET /api/v1/learning-routes": "bearer",
  "POST /api/v1/learning-routes": "bearer",
  "POST /api/v1/learning-routes/{route_id}/confirm": "bearer",
  "POST /api/v1/learning-routes/{route_id}/refresh": "bearer",
